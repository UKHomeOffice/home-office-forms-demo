...
const baseUrl = config.saveService.host + ':' + config.saveService.port + '/applied-before/';
...
module.exports = superclass => class extends superclass {
  cleanSession(req) {
    ...
    req.sessionModel.set('steps', ['/begin', '/applied-before']);
  }
  ...
  locals(req, res) {
    ...
    return Object.assign({}, superlocals, data);
  }
